...
#if 0
TEST_F (TestTestCases, regsmtparse0)
{
  d_expect_parse_error = true;
  run_test_case_test ("regsmtparse0", ".smt", "regsmtparse0");
}

TEST_F (TestTestCases, DISABLED_regsmtparse1)
{
  run_test_case_test ("regsmtparse1", ".smt", "regsmtparse1");
}

TEST_F (TestTestCases, regsmtparse2)
{
  run_test_case_test ("regsmtparse2", ".smt", "regsmtparse2");
}

TEST_F (TestTestCases, smttrue)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smttrue", ".smt", "smttrue");
}

TEST_F (TestTestCases, smtfalse)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtfalse", ".smt", "smtfalse");
}

TEST_F (TestTestCases, smtvar)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtvar", ".smt", "smtvar");
}

TEST_F (TestTestCases, smtnotvar)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtnotvar", ".smt", "smtnotvar");
}

TEST_F (TestTestCases, smtandvar)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtandvar", ".smt", "smtandvar");
}

TEST_F (TestTestCases, smtxor)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtxor", ".smt", "smtxor");
}

TEST_F (TestTestCases, smtor)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtor", ".smt", "smtor");
}

TEST_F (TestTestCases, smtiff)
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("smtiff", ".smt", "smtiff");
}

TEST_F (TestTestCases, smtflet)
{
  run_test_case_test ("smtflet", ".smt", "smtflet");
}

TEST_F (TestTestCases, smtbv255)
{
  run_test_case_test ("smtbv255", ".smt", "smtbv255");
}

TEST_F (TestTestCases, smtshl1)
{
  run_test_case_test ("smtshl1", ".smt", "smtshl1");
}

TEST_F (TestTestCases, smtshl2)
{
  run_test_case_test ("smtshl2", ".smt", "smtshl2");
}

TEST_F (TestTestCases, smtshl3)
{
  run_test_case_test ("smtshl3", ".smt", "smtshl3");
}

TEST_F (TestTestCases, smtlshr1)
{
  run_test_case_test ("smtlshr1", ".smt", "smtlshr1");
}

TEST_F (TestTestCases, smtlshr2)
{
  run_test_case_test ("smtlshr2", ".smt", "smtlshr2");
}

TEST_F (TestTestCases, smtlshr3)
{
  run_test_case_test ("smtlshr3", ".smt", "smtlshr3");
}

TEST_F (TestTestCases, smtashr1)
{
  run_test_case_test ("smtashr1", ".smt", "smtashr1");
}

TEST_F (TestTestCases, smtashr2)
{
  run_test_case_test ("smtashr2", ".smt", "smtashr2");
}

TEST_F (TestTestCases, smtashr3)
{
  run_test_case_test ("smtashr3", ".smt", "smtashr3");
}

TEST_F (TestTestCases, smtbvbin)
{
  run_test_case_test ("smtbvbin", ".smt", "smtbvbin");
}

TEST_F (TestTestCases, smtbvhex)
{
  run_test_case_test ("smtbvhex", ".smt", "smtbvhex");
}

TEST_F (TestTestCases, smtrepeat)
{
  run_test_case_test ("smtrepeat", ".smt", "smtrepeat");
}

TEST_F (TestTestCases, smtzeroextend)
{
  run_test_case_test ("smtzeroextend", ".smt", "smtzeroextend");
}

TEST_F (TestTestCases, smtsignextend)
{
  run_test_case_test ("smtsignextend", ".smt", "smtsignextend");
}

TEST_F (TestTestCases, smtrotate)
{
  run_test_case_test ("smtrotate", ".smt", "smtrotate");
}
...
{
  run_test_case_test ("regsmod1", ".smt", "regsmod1");
}
...
{
  run_test_case_test ("smtaxiommccarthy", ".smt", "smtaxiommccarthy");
}

TEST_F (TestTestCases, mulassoc4)
{
  run_test_case_test ("mulassoc4", ".smt", "mulassoc4");
}

TEST_F (TestTestCases, mulassoc5)
{
  run_test_case_test ("mulassoc5", ".smt", "mulassoc5");
}

TEST_F (TestTestCases, mulassoc6)
{
  run_test_case_test ("mulassoc6", ".smt", "mulassoc6");
}
...
TEST_F (TestTestCases, arrayand)
{
  run_test_case_test ("arrayand", ".btor", "arrayand");
}
...
TEST_F (TestTestCases, dumpbtor2)
{
  d_dump = "btor";
...
{
  run_test_case_test ("smtextarrayaxiom1uf", ".smt", "smtextarrayaxiom1uf");
}

TEST_F (TestTestCases, smtextarrayaxiom1)
{
  run_test_case_test ("smtextarrayaxiom1", ".smt", "smtextarrayaxiom1");
}

TEST_F (TestTestCases, smtextarray1sat0)
{
  run_test_case_test ("smtextarray1sat0", ".smt", "smtextarray1sat0");
}

TEST_F (TestTestCases, smtextarray1sat1)
{
  run_test_case_test ("smtextarray1sat1", ".smt", "smtextarray1sat1");
}

TEST_F (TestTestCases, smtextarrayaxiom2uf)
{
  run_test_case_test ("smtextarrayaxiom2uf", ".smt", "smtextarrayaxiom2uf");
}

TEST_F (TestTestCases, smtextarrayaxiom2)
{
  run_test_case_test ("smtextarrayaxiom2", ".smt", "smtextarrayaxiom2");
}

TEST_F (TestTestCases, smtextarray2sat0)
{
  run_test_case_test ("smtextarray2sat0", ".smt", "smtextarray2sat0");
}

TEST_F (TestTestCases, smtextarray2sat1)
{
  run_test_case_test ("smtextarray2sat1", ".smt", "smtextarray2sat1");
}

TEST_F (TestTestCases, smtextarray2sat2)
{
  run_test_case_test ("smtextarray2sat2", ".smt", "smtextarray2sat2");
}

TEST_F (TestTestCases, smtextarray2sat3)
{
  run_test_case_test ("smtextarray2sat3", ".smt", "smtextarray2sat3");
}

TEST_F (TestTestCases, smtextarrayaxiom3uf)
{
  run_test_case_test ("smtextarrayaxiom3uf", ".smt", "smtextarrayaxiom3uf");
}

TEST_F (TestTestCases, smtextarrayaxiom3)
{
  run_test_case_test ("smtextarrayaxiom3", ".smt", "smtextarrayaxiom3");
}

TEST_F (TestTestCases, smtextarray3sat0)
{
  run_test_case_test ("smtextarray3sat0", ".smt", "smtextarray3sat0");
}

TEST_F (TestTestCases, smtextarray3sat1)
{
  run_test_case_test ("smtextarray3sat1", ".smt", "smtextarray3sat1");
}

TEST_F (TestTestCases, smtextarray3sat2)
{
  run_test_case_test ("smtextarray3sat2", ".smt", "smtextarray3sat2");
}

TEST_F (TestTestCases, smtextarray3sat3)
{
  run_test_case_test ("smtextarray3sat3", ".smt", "smtextarray3sat3");
}

TEST_F (TestTestCases, smtextarray3sat4)
{
  run_test_case_test ("smtextarray3sat4", ".smt", "smtextarray3sat4");
}

TEST_F (TestTestCases, smtextarray3sat5)
{
  run_test_case_test ("smtextarray3sat5", ".smt", "smtextarray3sat5");
}

TEST_F (TestTestCases, smtextarray3sat6)
{
  run_test_case_test ("smtextarray3sat6", ".smt", "smtextarray3sat6");
}

TEST_F (TestTestCases, smtextarray3sat7)
{
  run_test_case_test ("smtextarray3sat7", ".smt", "smtextarray3sat7");
}

TEST_F (TestTestCases, smtextarrayaxiom4uf)
{
  run_test_case_test ("smtextarrayaxiom4uf", ".smt", "smtextarrayaxiom4uf");
}

TEST_F (TestTestCases, smtextarrayaxiom4)
{
  run_test_case_test ("smtextarrayaxiom4", ".smt", "smtextarrayaxiom4");
}
...
{
  run_test_case_test ("extarraywrite3", ".smt", "extarraywrite3");
}

TEST_F (TestTestCases, extarraywrite3sat)
{
  run_test_case_test ("extarraywrite3sat", ".smt", "extarraywrite3sat");
}

TEST_F (TestTestCases, smtarraycond1)
{
  run_test_case_test ("smtarraycond1", ".smt", "smtarraycond1");
}

TEST_F (TestTestCases, smtarraycond2)
{
  run_test_case_test ("smtarraycond2", ".smt", "smtarraycond2");
}

TEST_F (TestTestCases, smtarraycond3)
{
  run_test_case_test ("smtarraycond3", ".smt", "smtarraycond3");
}

TEST_F (TestTestCases, rwpropindexplusconst1)
{
  run_test_case_test ("rwpropindexplusconst1", ".btor", "rwpropindexplusconst1");
}

TEST_F (TestTestCases, rwpropindexplusconst2)
{
  run_test_case_test ("rwpropindexplusconst2", ".btor", "rwpropindexplusconst2");
}

TEST_F (TestTestCases, rwpropindexplusconst3)
{
  run_test_case_test ("rwpropindexplusconst3", ".btor", "rwpropindexplusconst3");
}

TEST_F (TestTestCases, rwpropindexplusconst4)
{
  run_test_case_test ("rwpropindexplusconst4", ".btor", "rwpropindexplusconst4");
}
...
TEST_F (TestTestCases, rw46)
{
  run_test_case_test ("rw46", ".btor", "rw46");
}

TEST_F (TestTestCases, rw47)
{
  run_test_case_test ("rw47", ".btor", "rw47");
}

TEST_F (TestTestCases, rw48)
{
  run_test_case_test ("rw48", ".btor", "rw48");
}

TEST_F (TestTestCases, rw49)
{
  run_test_case_test ("rw49", ".btor", "rw49");
}

TEST_F (TestTestCases, rw50)
{
  run_test_case_test ("rw50", ".btor", "rw50");
}

TEST_F (TestTestCases, rw51)
{
  run_test_case_test ("rw51", ".btor", "rw51");
}
...
TEST_F (TestTestCases, rw60)
{
  run_test_case_test ("rw60", ".btor", "rw60");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 3);
  run_test_case_test ("rw212", ".smt", "rw212");
}

TEST_F (TestTestCases, rw213)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 3);
  run_test_case_test ("rw213", ".smt", "rw213");
}

TEST_F (TestTestCases, rw214)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 3);
  run_test_case_test ("rw214", ".smt", "rw214");
}

TEST_F (TestTestCases, rw215)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 3);
  run_test_case_test ("rw215", ".smt", "rw215");
}

TEST_F (TestTestCases, rw216)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 3);
  run_test_case_test ("rw216", ".smt", "rw216");
}
...
TEST_F (TestTestCases, hd19)
{
  run_test_case_test ("hd19", ".btor", "hd19");
}

TEST_F (TestTestCases, hd20)
{
  run_test_case_test ("hd20", ".btor", "hd20");
}

TEST_F (TestTestCases, hd21)
{
  run_test_case_test ("hd21", ".btor", "hd21");
}
...
{
  run_test_case_test ("bubsort002un", ".smt", "bubsort002un");
}

TEST_F (TestTestCases, selsort002un)
{
  run_test_case_test ("selsort002un", ".smt", "selsort002un");
}

TEST_F (TestTestCases, swapmem002se)
{
  run_test_case_test ("swapmem002se", ".smt", "swapmem002se");
}

TEST_F (TestTestCases, swapmem002ue)
{
  run_test_case_test ("swapmem002ue", ".smt", "swapmem002ue");
}

TEST_F (TestTestCases, wchains002se)
{
  run_test_case_test ("wchains002se", ".smt", "wchains002se");
}

TEST_F (TestTestCases, wchains002ue)
{
  run_test_case_test ("wchains002ue", ".smt", "wchains002ue");
}

TEST_F (TestTestCases, dubreva002ue)
{
  run_test_case_test ("dubreva002ue", ".smt", "dubreva002ue");
}

TEST_F (TestTestCases, binarysearch32s016)
{
  run_test_case_test ("binarysearch32s016", ".smt", "binarysearch32s016");
}

TEST_F (TestTestCases, countbits016)
{
  run_test_case_test ("countbits016", ".smt", "countbits016");
}

TEST_F (TestTestCases, fifo32bc04k05)
{
  run_test_case_test ("fifo32bc04k05", ".smt", "fifo32bc04k05");
}

TEST_F (TestTestCases, fifo32ia04k05)
{
  run_test_case_test ("fifo32ia04k05", ".smt", "fifo32ia04k05");
}

TEST_F (TestTestCases, fifo32in04k05)
{
  run_test_case_test ("fifo32in04k05", ".smt", "fifo32in04k05");
}

TEST_F (TestTestCases, nextpoweroftwo016)
{
  run_test_case_test ("nextpoweroftwo016", ".smt", "nextpoweroftwo016");
}

TEST_F (TestTestCases, memcpy02)
{
  run_test_case_test ("memcpy02", ".smt", "memcpy02");
}
...
TEST_F (TestTestCases, lin0)
{
  run_test_case_test ("lin0", ".btor", "lin0");
}

TEST_F (TestTestCases, lin1)
{
  run_test_case_test ("lin1", ".btor", "lin1");
}

TEST_F (TestTestCases, lin2)
{
  run_test_case_test ("lin2", ".btor", "lin2");
}

TEST_F (TestTestCases, lin3)
{
  run_test_case_test ("lin3", ".btor", "lin3");
}

TEST_F (TestTestCases, lin4)
{
  run_test_case_test ("lin4", ".btor", "lin4");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("inc", ".btor", "inc_rwl0");
}

TEST_F (TestTestCases, inc_rwl3)
{
  run_test_case_test ("inc", ".btor", "inc_rwl3");
}

TEST_F (TestTestCases, dec_rwl0)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("dec", ".btor", "dec_rwl0");
}

TEST_F (TestTestCases, dec_rwl3)
{
  run_test_case_test ("dec", ".btor", "dec_rwl3");
}

TEST_F (TestTestCases, regrembeddedconstraint1_0)
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint1", ".btor", "regrembeddedconstraint1");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint2", ".btor", "regrembeddedconstraint2");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint3", ".btor", "regrembeddedconstraint3");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint4", ".btor", "regrembeddedconstraint4");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint5", ".btor", "regrembeddedconstraint5");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint6", ".btor", "regrembeddedconstraint6");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint7", ".btor", "regrembeddedconstraint7");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint8", ".btor", "regrembeddedconstraint8");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint9", ".btor", "regrembeddedconstraint9");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint10", ".btor", "regrembeddedconstraint10");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint11", ".btor", "regrembeddedconstraint11");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint12", ".btor", "regrembeddedconstraint12");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint13", ".btor", "regrembeddedconstraint13");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 0);
  run_test_case_test ("regrembeddedconstraint14", ".btor", "regrembeddedconstraint14");
}
...
{
  boolector_set_opt(d_btor, BTOR_OPT_MODEL_GEN, 1);
  run_test_case_test ("problem_130", ".smt", "problem_130");
}
...
TEST_F (TestTestCases, painc)
{
  ...
  run_test_case_test ("painc", ".smt", "painc");
}

TEST_F (TestTestCases, sult)
{
  run_test_case_test ("sult", ".btor", "sult");
}
...
TEST_F (TestTestCases, regrbetacache2)
{
  boolector_set_opt(d_btor, BTOR_OPT_BETA_REDUCE_ALL, 1);
...
{
  boolector_set_opt(d_btor, BTOR_OPT_REWRITE_LEVEL, 1);
  run_test_case_test ("regrlemmaloop_embeddedconstraints", ".btor", "regrlemmaloop_embeddedconstraints");
}
...
{
  d_dump = "btor";
  run_test_case_test ("normalize_add_incomplete", ".btor", "normalize_add_incomplete");
}

TEST_F (TestTestCases, normalize_mul_incomplete)
{
  d_dump = "btor";
  run_test_case_test ("normalize_mul_incomplete", ".btor", "normalize_mul_incomplete");
}

TEST_F (TestTestCases, normalize_and_incomplete)
{
  d_dump = "btor";
  run_test_case_test ("normalize_and_incomplete", ".btor", "normalize_and_incomplete");
}
