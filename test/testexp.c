...
test_zero_exp (void)
{
  ...
  assert (btor_node_bv_get_width (g_btor, exp1) == 8);
  assert (btor_node_bv_get_width (g_btor, exp2) == 8);
  assert (btor_node_is_bv_const_zero (g_btor, exp1));
  assert (btor_node_is_bv_const_zero (g_btor, exp2));
  assert (!btor_node_is_bv_const_zero (g_btor, btor_node_invert (exp1)));
  assert (!btor_node_is_bv_const_zero (g_btor, btor_node_invert (exp2)));
  assert (btor_node_is_bv_const_ones (g_btor, btor_node_invert (exp1)));
  assert (btor_node_is_bv_const_ones (g_btor, btor_node_invert (exp2)));
...
test_ones_exp (void)
{
  ...
  assert (btor_node_bv_get_width (g_btor, exp1) == 8);
  assert (btor_node_bv_get_width (g_btor, exp2) == 8);
  assert (btor_node_is_bv_const_ones (g_btor, exp1));
  assert (btor_node_is_bv_const_ones (g_btor, exp2));
  assert (!btor_node_is_bv_const_ones (g_btor, btor_node_invert (exp1)));
  assert (!btor_node_is_bv_const_ones (g_btor, btor_node_invert (exp2)));
  assert (btor_node_is_bv_const_zero (g_btor, btor_node_invert (exp1)));
  assert (btor_node_is_bv_const_zero (g_btor, btor_node_invert (exp2)));
