...
(let (?e41 (extract[1:0] v6))
(let (?e42 bv0[2])
(let (?e43 (ite (= ?e41 ?e42) bv1[1] bv0[1]))
(let (?e44 (bvand (bvnot ?e40) ?e43))
(let (?e45 (extract[1:0] v7))
(let (?e46 (ite (= ?e42 ?e45) bv1[1] bv0[1]))
(let (?e47 (bvand ?e44 ?e46))
(not (= ?e47 bv0[1]))
)))))))))))))))))))))))))))))))))))))))))))))
