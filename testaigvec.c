...
test_is_equal_aigvec (void)
{
  ...
  assert (!btor_is_equal_aigvec (avmgr, av1, av2));
  assert (!btor_is_equal_aigvec (avmgr, av2, av1));
  assert (!btor_is_equal_aigvec (avmgr, av3, av4));
  assert (!btor_is_equal_aigvec (avmgr, av4, av3));
  assert (btor_is_equal_aigvec (avmgr, av1, av1));
  assert (btor_is_equal_aigvec (avmgr, av2, av2));
  assert (btor_is_equal_aigvec (avmgr, av3, av3));
  assert (btor_is_equal_aigvec (avmgr, av4, av4));
  btor_release_delete_aigvec (avmgr, av1);
  btor_release_delete_aigvec (avmgr, av2);
  btor_release_delete_aigvec (avmgr, av3);
  btor_release_delete_aigvec (avmgr, av4);
