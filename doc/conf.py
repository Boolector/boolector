...
# -*- coding: utf-8 -*-
#
# boolector documentation build configuration file, created by
# sphinx-quickstart on Tue Sep 30 10:16:10 2014.
#
...
print("#### " + str(os.path.abspath('../build/')))
...
project = 'Boolector'
copyright = '2007-2016, Institute for Formal Models and Verification, Johannes Kepler University, Linz, Austria'
